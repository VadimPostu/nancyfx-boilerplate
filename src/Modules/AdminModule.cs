...
namespace NancyBoilerplate.Web.Modules
{
    public class AdminModule : NancyModule
    {
        ...
        private dynamic Post_UsersAdd(dynamic arg)
        {
            ...
            var user = _userMapper.CreateUser(viewModel.UserName, viewModel.Email, viewModel.Password, claims.ToArray());
        ...
        private dynamic Post_UserEdit(Guid uniqueId)
        {
            ...
            if (_session.Query<User>().Where(u => (u.Email == viewModel.Email && u.UniqueId != user.UniqueId)).FirstOrDefault() != null ||
